package com.example.ssdassignment2webapi.config;
...
@Configuration
@EnableMongoRepositories("com.example.ssdassignment2webapi.repository")
public class MongoConfiguration extends AbstractMongoClientConfiguration {
    ...
    public MongoClient mongoClient() {
        ...
        try {
            ...
            System.out.println("Exception in creating SSL Context : ");
            System.out.println("Exception in creating SSL Context : ");
            System.out.println("Exception in creating SSL Context : ");
            System.out.println("Exception in creating SSL Context : ");
            System.out.println("Exception in creating SSL Context : ");
